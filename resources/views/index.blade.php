...
<body>
    ...
    <header>
        <div class=" navbar navbar - dark bg - dark shadow - sm">
            <a href="#" class=" navbar - brand d - flex align - items - center ">
                <strong> Meu álbum de fotos </strong>
            </a>
        </div>
    </header>
    ...
    <main role=" main ">
        ...
        <section class=" jumbotron text - center ">
            <div class=" container">
                <h1 class=" jumbotron - heading"> Escreva aqui seu novo Post
                </h1>
...
email " placeholder=" nome@dominio. com">
                    ...
                    <div class=" custom - file ">
                        ...
                        <label class=" custom - file - label " id=" RotuloArquivo" for="
arquivo"> Escolha um arquivo </label>
                    </div>
                    <div class=" form - group text - left ">
 ...
 </html>                     <div class="d-flex justify-content-between align-items
-center ">
                                                    <div class=" btn-group ">
